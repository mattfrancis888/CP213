...
public class week9 {
	...
	public class BoxLayOutTest extends JFrame {
	 ...
	 //The JComponent class is the base class of all Swing components
      ...
      //Actioncommands
      //used to identify which component is clicked
      myButton.setActionCommand("Yes");
      public void actionPerformed(ActionEvent e){
      ...
      //JButotn and Jemnu are derived classes of the AbstractButton
...
//text area and text field can have a setting where it's editable or not:
	...
	//SetWindowListenr registers a window listener
	 ...
	 WindowAdapter - Windowlistener have a bunch of itnerfaces (7) you need to implement,
