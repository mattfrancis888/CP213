 ...
 */
public class LifeForm_3 implements LifeProperty_interface, DeathProperty_interface {
	...
	LifeForm_3(String entity, String name) {
		this.entity = entity;
		this.name   = name;
	}
     ...
     * @return this
     */
	public void reproduction_mechanism(String reproduction) {
	...
	public void describe() {
		//Describe is in lifeproperty interface
		System.out.println();
		System.out.println(">>>> Organism Described by Class> LifeForm_3");
