...
public class ArraySearchPanel extends JPanel {
    ...
    // ---------------------------------------------------------------------
   /**
     * An inner class that uses an ActionListener to access <code>searchButton</code>.
     * It displays the result of the array search when pressed and catches
     * any input and search errors.
     */
    ...
    private void findValue() throws ValueNotFoundException {
	   ...
	   try {
	      ...
	      ArraySearchPanel.this.indexLabel.setText("" + i);
	                                 ...
	                                 // parameter.
	      throw new ValueNotFoundException(new Integer(value));
	   }
    }
